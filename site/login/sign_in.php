            ...
            <div class="card">
                <form action="" method="POST" class="card-body text-center">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="name_user" class="form-control " id="user_name" placeholder="Username" value="<?php if (isset($_COOKIE['username'])) {
                    ...
                    <div class="input-group mb-4">
                        <input type="password" name="pass_user" class="form-control " id="password" placeholder="password" value="<?php if (isset($_COOKIE['password'])) {
