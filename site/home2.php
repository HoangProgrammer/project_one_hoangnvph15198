                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                ...
                                <a href="site/hoc/learn.php" class="col-md-6 col-xl-4">
                                    <div class="card daily-sales course-english">
                                        <img class="course-english-img" src="assets/images/slider/english-communication.jpg" alt="">
                                ...
                                <a href="" class="col-md-6 col-xl-4">
                                    <div class="card daily-sales course-english">
                                        <img class="course-english-img" src="assets/images/slider/english-communication2.jpg" alt="">
                                    </div>
                                    <span class="course-english-tile">
                                        HTML, CSS từ Zero đến Hero
                                   </span>
                                ...
                                <a href="" class="col-md-6 col-xl-4">
                                    <div class="card daily-sales course-english">
                                        <img class="course-english-img" src="assets/images/slider/english-communication3.jpg" alt="">
                                    </div>
                                    <span class="course-english-tile" >
                                        HTML, CSS từ Zero đến Hero
                                   </span>
