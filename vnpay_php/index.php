...
<?php
    ...
    if(isset($_POST['button'])){
        ...
        setcookie('id_course',$id_caurse ,time() + (86400 * 7));
        setcookie('code',$id_oder ,time() + (86400 * 7));
        setcookie('money',$money ,time() + (86400 * 7));
       setcookie('id_user',$id_user ,time() + (86400 * 7));
        setcookie('time',$time ,time() + (86400 * 7));
                ...
                <form action="" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <select name="order_type" id="order_type" class="form-control">
                            <option value="topup"><?=  $name?></option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input min="<?=$price?>" max="<?=$price?>" class="form-control" id="amount" name="amount" type="number" value="<?=$price?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <a id="A"  name="button" class="btn btn-primary" >Xác</a>
...
<?php   
 header( "refresh:2;url=index.html?act=detail_order"); 
