                    ...
                    <div class="modal-content">
                      ...
                      <div class="form-group">
                          ...
                          <p class="text-danger error_name"> <?php if(isset(  $_SESSION['name'])){
                           ...
                           <input type="radio" name="type" value="0" class="form-radio1 input_form" <?php if($type=="0"){echo "checked" ;}else{}   ?>  />
                           <label class="form-label" for="">  Mất phí </label>
                            ...
                            <input type="text" name="price_course" id="price"  class="form-control input_form" value=" <?= $gia ?>" />    
                            </div> 
